...
[NUMERIC, TXT, RAW] = xlsread('NASDAQ_Composite_2015_2016.xlsx');
% Calculate the volatility of stock price in the financial crisis in 2015,
% we use the square of the absolute stock price change to represent the
% volatility
Price_20160211 = cell2mat(RAW(2:end, 8));
Price_20151229 = cell2mat(RAW(2:end, 7));
Volatility_bet_20151229_and_20160211 = (Price_20160211 - Price_20151229) .^ 2;

%% 0 - 1 integer programming to select 20 stocks for risk averse investors

% Construct the objective functions and constraints based on the weights of
% various industries in the members of the NASDAQ Composite index
f = Volatility_bet_20151229_and_20160211;
All = ones(1, 300);
...
Software(30:56) = 1;
Biotechnology(57:81) = 1;
Banks(82:102) = 1;
Media(103:115) = 1;
Health_care_equipment(116:127) = 1;
Capital_markets(128:138) = 1;
Interactive_media(139:148) = 1;
IT_services(149:158) = 1;
Entertainment(159:167) = 1;
...
A = [-All; Semiconductor; Software; Biotechnology; Banks; Media; Capital_markets; ...
     Health_care_equipment; Interactive_media; IT_services; Entertainment; ...
